...
"""
import os
fla_triton_cache = ".cache/fla_h20_issue_640"
os.environ["TRITON_CACHE_DIR"] = fla_triton_cache

print(f"Using Triton cache directory: {os.environ['TRITON_CACHE_DIR']}")
...
assert_close('db',   ref_dbeta, tri_dbeta, 0.02)   # fails on H20/H100 + Triton 3.5
assert_close('dg',   ref_dg,    tri_dg,    0.02)   # fails on H20/H100 + Triton 3.5
